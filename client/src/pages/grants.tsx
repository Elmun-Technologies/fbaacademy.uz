  ...
  return (
    <Layout>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={i} className="rounded-2xl border bg-white p-6 shadow-lg dark:bg-card" data-testid={`card-promo-${i}`}>
                <div className="mb-4 flex items-center justify-between gap-2">
                  ...
                  <span className="text-3xl font-extrabold text-foreground">-{promo.discount}</span>
                </div>
      ...
      <section className="py-16 sm:py-20" data-testid="section-grants-form">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-xl rounded-2xl border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-orange-50 p-8 text-center shadow-lg dark:border-amber-800 dark:from-amber-950/30 dark:to-orange-950/30">
