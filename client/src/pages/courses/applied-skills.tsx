...
import { APPLIED_SKILLS_PAGE, appliedSkillsJsonLd } from "@/lib/i18n/applied-skills-page";
...
const LEARN_ICONS = [BookOpen, TrendingUp, Award, BookOpen, Users, TrendingUp] as const;
...
export default function AppliedSkillsPage() {
  ...
  useSEO({
    ...
    breadcrumb: [
      ...
      { name: "Applied Skills", url: `${BASE_URL}/course/applied-skills` },
    ],
    hreflang: [
      { lang: "en", url: `${BASE_URL}/course/applied-skills` },
      { lang: "uz", url: `${BASE_URL}/course/applied-skills?lang=uz` },
      { lang: "ru", url: `${BASE_URL}/course/applied-skills?lang=ru` },
      { lang: "x-default", url: `${BASE_URL}/course/applied-skills` },
    ],
    jsonLd: appliedSkillsJsonLd(lang, BASE_URL),
  });
    ...
    <Layout>
      <nav className="mx-auto max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
        <ol className="flex flex-wrap items-center gap-1.5 text-sm text-zinc-500">
          ...
          <li>/</li>
          <li className="text-white font-medium">Applied Skills</li>
        </ol>
      </nav>

      <section className="relative overflow-hidden bg-gradient-to-br from-violet-950 via-slate-800 to-slate-900 pb-16 pt-10 sm:pb-20 sm:pt-14">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-5 lg:gap-12">
            <div className="lg:col-span-3">
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-violet-400/30 bg-violet-400/10 px-3 py-1.5 text-xs font-semibold text-violet-300"><Award className="h-3.5 w-3.5" /> {tx.badge}</div>
            ...
            <div className="lg:col-span-2">
              <div className="rounded-2xl border border-white/10 bg-zinc-900 p-6 shadow-2xl">
                ...
                <LazyLeadForm source="course-applied-skills" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {tx.learn.map((item, i) => {
              ...
              return (
                <div key={i} className="overflow-hidden rounded-xl border border-white/10 bg-zinc-900">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {tx.forWhom.map((text, i) => {
              ...
              return (
                <div key={i} className="flex items-start gap-3 rounded-xl border border-white/10 border-l-4 border-l-violet-500 bg-zinc-900 p-5">
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {tx.why.map((item, i) => (
              <div key={i} className="flex items-start gap-3 rounded-xl border border-white/10 bg-zinc-900 p-5">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-violet-500/20 text-xs font-bold text-violet-300">{i + 1}</span>
                <span className="text-sm font-medium text-zinc-200">{item}</span>
              </div>
            ))}
          </div>
      ...
      <section id="enroll" className="bg-gradient-to-br from-violet-950 via-violet-800 to-slate-900 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div className="rounded-2xl border border-white/10 bg-zinc-900 p-6 shadow-2xl">
              ...
              <DeferredLeadForm source="course-applied-skills-cta" />
            </div>
          </div>
        </div>
      </section>
