...
export default function AccaPage() {
  ...
  return (
    <Layout>
          ...
          <div className="grid gap-10 lg:grid-cols-5 lg:gap-12">
            <div className="lg:col-span-3 animate-fade-in-up">
              ...
              <div className="mt-5 flex items-center gap-4">
                ...
                <span className="text-sm text-zinc-500">{course.studentsCount} {t.page.students}</span>
      ...
      {/* ACCA Global Stats */}
      <section className="bg-zinc-900 py-10 dark:bg-background" data-testid="section-global-stats">
      ...
      {/* YouTube */}
      <section className="bg-[#111] py-14" data-testid="section-video">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              <h2 className="text-4xl font-extrabold uppercase tracking-tight text-white" data-testid="text-video-title">{tx.videoTitle}</h2>
              <p className="mt-4 text-zinc-400 leading-relaxed">{tx.videoDesc}</p>
      ...
      <section className="py-14 sm:py-20" data-testid="section-salary">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-zinc-900 p-6 shadow-2xl sm:p-10">
            ...
            <p className="mt-6 text-xs text-zinc-500">{t.page.salary.source}</p>
          </div>
        </div>
      </section>

      {/* Skills */}
      <section className="bg-[#111] py-14" data-testid="section-skills">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      {/* Modules */}
      <section className="bg-[#111] py-14" data-testid="section-modules">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <Link href="/contacts">
                <Button size="lg" className="mt-6 gap-2 rounded-full bg-amber-400 px-8 font-bold text-black hover:bg-amber-300" data-testid="button-cta">
      ...
      <section className="py-14 sm:py-20" data-testid="section-faq">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-3xl">
            <Accordion type="multiple" className="space-y-3">
              {faqs.map((faq) => (
                <AccordionItem key={faq.id} value={faq.id} className="rounded-2xl border border-white/10 bg-zinc-900 px-6" data-testid={`faq-${faq.id}`}>
