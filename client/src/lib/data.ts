...
export const categories = [
  ...
  { name: "Moliya", slug: "finance", icon: "TrendingUp" },
  { name: "Huquqshunoslik", slug: "law", icon: "Briefcase" },
  { name: "Buxgalteriya", slug: "accounting", icon: "Code" },
];
...
export const courses: Course[] = [
  {
    ...
    shortDescription: "Xalqaro buxgalteriya sertifikati — karerangizni global darajaga olib chiqing",
    modules: [
    ...
    supportTeam: [
      { role: "Kurator-ekspert", description: "Uy vazifalarini batafsil ko'rib chiqadi, yaxshilashga yordam beradi", avatar: "/images/teacher-1.png" },
      { role: "HR-konsultant", description: "Ish topishda yordam beradi: reja tuzishdan to suhbatgacha", avatar: "/images/teacher-2.png" },
      { role: "Qo'llab-quvvatlash", description: "Platforma va kursni o'tish bo'yicha savollarga javob beradi", avatar: "/images/teacher-3.png" },
    ],
    mentorId: "teacher-1",
  ...
  },
  {
    ...
    supportTeam: [
      { role: "Kurator-ekspert", description: "Har bir mavzu bo'yicha tushuntirishlar va amaliy mashqlar", avatar: "/images/teacher-1.png" },
      { role: "HR-konsultant", description: "Ish topishda yordam va rezyume tayyorlash", avatar: "/images/teacher-2.png" },
      { role: "Qo'llab-quvvatlash", description: "Platforma va kursni o'tish bo'yicha savollarga javob beradi", avatar: "/images/teacher-3.png" },
    ],
    mentorId: "teacher-1",
    image: "/images/course-business.png",
  ...
  },
  {
    ...
    supportTeam: [
      { role: "Kurator-ekspert", description: "Murakkab mavzularni tushuntirish va amaliyot", avatar: "/images/teacher-1.png" },
      { role: "HR-konsultant", description: "Xalqaro kompaniyalarga ishga joylashish", avatar: "/images/teacher-2.png" },
      { role: "Qo'llab-quvvatlash", description: "Texnik va tashkiliy yordam", avatar: "/images/teacher-3.png" },
    ],
    mentorId: "teacher-2",
    image: "/images/course-business.png",
    practiceHours: "150",
  ...
  },
  {
    ...
    tools: ["SAP S/4HANA", "Bloomberg Terminal", "Capital IQ", "Refinitiv", "Advanced Excel", "Power BI", "Python (Data Analysis)"],
    salaryLevels: [
    ...
    supportTeam: [
      { role: "Kurator-ekspert", description: "Strategik masalalar va case study'larni tahlil qiladi", avatar: "/images/teacher-1.png" },
      { role: "HR-konsultant", description: "Top lavozimlar va xalqaro imkoniyatlar", avatar: "/images/teacher-2.png" },
      { role: "Qo'llab-quvvatlash", description: "Imtihonga tayyorgarlik va texnik yordam", avatar: "/images/teacher-3.png" },
    ],
    mentorId: "teacher-2",
    image: "/images/course-business.png",
    practiceHours: "180",
  ...
  },
  {
    ...
    supportTeam: [
      { role: "Kurator-ekspert", description: "IFRS standartlarini amaliyotda qo'llashni o'rgatadi", avatar: "/images/teacher-3.png" },
      { role: "HR-konsultant", description: "Xalqaro kompaniyalarga ish topishda yordam beradi", avatar: "/images/teacher-2.png" },
      { role: "Qo'llab-quvvatlash", description: "Imtihon tayyorligi va texnik yordam", avatar: "/images/teacher-4.png" },
    ],
    mentorId: "teacher-3",
  ...
  },
  {
    ...
    supportTeam: [
      { role: "Kurator-ekspert", description: "Real kompaniyalar ustida modellashtirish amaliyoti", avatar: "/images/teacher-4.png" },
      { role: "HR-konsultant", description: "Investitsiya banklari va konsalting firmalariga ish topish", avatar: "/images/teacher-2.png" },
      { role: "Qo'llab-quvvatlash", description: "Texnik va tashkiliy yordam", avatar: "/images/teacher-3.png" },
    ],
    mentorId: "teacher-4",
    image: "/images/course-programming.png",
    practiceHours: "120",
    theoryHours: "50",
    projects: "8",
    rating: "4.9",
  ...
  },
  {
    ...
    supportTeam: [
      { role: "Kurator-ekspert", description: "Real sud ishlari va huquqiy holatlar tahlili", avatar: "/images/teacher-2.png" },
      { role: "HR-konsultant", description: "Yuridik firmalar va kompaniyalarga ish topish", avatar: "/images/teacher-1.png" },
      { role: "Qo'llab-quvvatlash", description: "O'quv jarayoni va texnik yordam", avatar: "/images/teacher-4.png" },
    ],
    mentorId: "teacher-2",
  ...
  },
  {
    ...
    supportTeam: [
      { role: "Kurator-ekspert", description: "Real kompaniya ma'lumotlari bilan amaliyot", avatar: "/images/teacher-4.png" },
      { role: "HR-konsultant", description: "Buxgalterlik vakansiyalariga ish topish", avatar: "/images/teacher-1.png" },
      { role: "Qo'llab-quvvatlash", description: "1C dasturi bo'yicha texnik yordam", avatar: "/images/teacher-3.png" },
    ],
    mentorId: "teacher-4",
    image: "/images/course-programming.png",
    practiceHours: "100",
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    role: "Yurist",
    text: "Huquqshunoslik kursi menga biznes yuritishda zarur huquqiy bilimlarni berdi. Shartnomalar tuzish va soliq rejalash bo'yicha ko'nikmalarim sezilarli darajada oshdi.",
...
export const blogPosts: BlogPost[] = [
  {
    id: "blog-1",
    title: "ACCA sertifikati — karerangiz uchun eng yaxshi investitsiya",
...
export const graduateResults: GraduateResult[] = [
  ...
  },
  {
    ...
    salaryIncrease: "0 dan 12 000 000 UZS",
    avatar: "/images/student-2.png",
  ...
  },
  {
    ...
    salaryIncrease: "3 000 000 dan 12 000 000 UZS",
    avatar: "/images/student-3.png",
  ...
  },
  {
    ...
    company: "UzCard",
    salaryIncrease: "5 000 000 dan 25 000 000 UZS",
    avatar: "/images/student-4.png",
...
export const partnerCompanies = [
  "Deloitte", "PwC", "KPMG", "EY", "BDO", "Grant Thornton", "UzCard", "NBU", "IT Park", "Artel", "Payme", "Kapitalbank"
];
